...
function App() {
  ...
  const [cardsLists, setCardsLists] = useState([{
    id: 1,
    title: 'Сделать',
    items: [{ title: 'задание 1 доска 1', id: 111, order: 1 },
    ...
    id: 2,
    title: 'В работе',
    items: [{ title: 'задание 1 доска 2', id: 121, order: 1 },
    ...
    id: 3,
    title: 'Готово',
    items: [{ title: 'задание 1 доска 3', id: 131, order: 1 },
    ...
    <div className="page">
      <div className="page__content">
        ...
        <Routes>
          ...
          <Route path={main} element={true
            ? <ProtectedRoute element={MainPage} isLoggedIn={true} isLoading={false} />
            : <Auth
            isLoggedIn={loggedIn}
          ...
          element={<ProtectedRoute
            ...
            dropCard={dropCard} setDropCard={setDropCard}
            startBoard={startBoard} setStartBoard={setStartBoard}
            clearCards={clearCards} cardsLists={cardsLists}
