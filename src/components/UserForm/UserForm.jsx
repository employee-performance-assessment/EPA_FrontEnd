  ...
  return (
    <div className="user-form__wrapper">
      ...
      <form className="user-form__form" onSubmit={handleSubmit}>
        ...
        <button type='submit' className='user-form__submit-button' disabled={!isValid}>Подтвердить</button>
      </form>
      <button className="user-form__close-icon-block" type='button' onClick={handleClosePopup}>
          <img
            src={CloseIcon}
